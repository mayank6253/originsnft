...
export default function Collections() {
  ...
  const renderRelease = (releaseInfo, index) => {
    return (
      <div className="image-container" key={index}>
        ...
        >
          <img src={releaseInfo.img} className="card-img-top" alt="..." />
          <div className="card-body">
            <img src={releaseInfo.img2} alt="" className="img-collection" />
  ...
  return (
    <div>
      ...
      >
        ...
        >
          {releaseInfo.map(renderRelease)}
          {console.log(releaseInfo.map(renderRelease))}
        </Slider>
      </div>
